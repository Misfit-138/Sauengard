...
class Dragon(Monster):
    ...
    def __init__(self, level, experience_award, gold, sword, armor_bonus, shield, armor_class, strength, dexterity, constitution, intelligence, wisdom, charisma, hit_points, human_player_level):
        super().__init__(level, experience_award, gold, sword, armor_bonus, shield, armor_class, strength, dexterity, constitution, intelligence, wisdom, charisma, hit_points, human_player_level)
        self.level = level
