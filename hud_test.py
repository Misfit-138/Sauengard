...
class MyScreen(arcade.Window):
    ...
    def on_draw(self):
        ...
        arcade.draw_text("Name of Dungeon",
                         start_x,
                         start_y,
                         arcade.color.WHITE,
                         DEFAULT_FONT_SIZE * 1,
        ...
        arcade.draw_text(f"Strength: {player_1.strength}",
                         start_x,
                         start_y,
                         arcade.color.WHITE,
...
def hud():
    MyScreen(SCREEN_WIDTH, SCREEN_HEIGHT, SCREEN_TITLE)
    arcade.run()
